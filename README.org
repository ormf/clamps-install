...
**** Dependencies
     ...
     - Git
       ...
       Install git by typing "brew install git" in a terminal and
       finish with the retrun key.
 
     - Incudine dependencies:

       Install all incudine dependencies by typing the following lines
       into a Terminal and press the return key after each line.
     ...
     - libsndfile
       ...
       Install portmidi by typing "brew install libsndfile"
